...
namespace CloudBackend.Workers
{
    ...
    public class VerifyController: ControllerBase
    {
        public class Verify
        {
            public string token { get; set; } = Data.LoginDetails.AccountId;
            ...
            public string account_id { get; set; } = Data.LoginDetails.AccountId;
            ...
            public string display_name { get; set; } = Data.LoginDetails.DisplayName;
            public string app { get; set; } = "fortnite";
            public string in_app_id { get; set; } = Data.LoginDetails.AccountId;
            public string device_id { get; set; } = Data.LoginDetails.AccountId;
        }
        ...
        public class Login
        {
            public string access_token { get; set; } = Data.LoginDetails.AccountId + "EWNAKID";
            public int expires_in { get; set; } = 28800;
            ...
            public bool internal_client { get; set; } = true;
            public string client_service { get; set; } = "fortnite";
            public string displayName { get; set; } = Data.LoginDetails.DisplayName;
            public string app { get; set; } = "fortnite";
            public string in_app_id { get; set; } = Data.LoginDetails.AccountId;
        ...
        public ActionResult<Login> LoginOAuthToken([FromForm] string grant_type)
        {
            try
            {
                ...
                {
                    Data.LoginDetails.DisplayName = form["username"].ToString().Split("@", StringSplitOptions.None)[0];
                }
        ...
        public ActionResult KillSession(string accessToken)
        {
            ...
            public class Epics
            {
                public string id { get; set; } = Data.LoginDetails.AccountId;
                public string displayName { get; set; } = Data.LoginDetails.DisplayName;
                public string name { get; set; } = Data.LoginDetails.DisplayName;
                public string email { get; set; } = Data.LoginDetails.DisplayName + "@ohno.com";
            ...
            public ActionResult<Epics> PublicAccountOMG(string accessToken)
            {
                return new Epics();
            }
            ...
            public ActionResult<AccountModelTHingy> accounts([FromQuery] string accountId)
            {
                return new AccountModelTHingy();
            }
