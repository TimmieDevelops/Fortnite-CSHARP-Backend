...
namespace CloudBackend.Workers
{
    ...
    {
        [HttpPost("game/v2/tryPlayOnPlatform/account/{ohno}")]
        public ActionResult tryPlayOnPlatform(string ohno)
        {
        ...
        public ActionResult<string[]> enabled_features(string ohno)
        {
            return Array.Empty<string>();
        }

        [HttpGet("storefront/v2/keychain")]
        public ActionResult<List<string>> keychain()
        {
